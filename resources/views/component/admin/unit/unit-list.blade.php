    ...
    <div class="ms-auto">
        <div class="col">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#exampleVerticallycenteredModal">Add Unit</button>
...
<script>
    ...
    async function getUnit() {
        let res = await axios.get('/get-unit');
    ...
    async function updateUnitStatus(id, newStatus) {

        try {

            let res = await axios.post('/update-unit-status', {
                id,
                newStatus
            });
        } catch (error) {
