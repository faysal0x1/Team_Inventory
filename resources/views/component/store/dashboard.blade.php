<div class="page-wrapper">
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 col-xl-8 bg-white radius-10 m-3" style="width:63%">
                    <h4 class="m-3">Sales Overview</h4>
                    <div class="d-flex">
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Sales.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-5">₹ 832</h5>
                                    <p class="me-2">Sales</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    {{-- <i class='bx bx-cart fs-3 text-black'></i> --}}
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Revenue.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-4">₹ 832</h5>
                                    <p class="me-2">Revenue</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Profit.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-5">₹ 832</h5>
                                    <p class="me-2">Profit</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Cost.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-5">₹ 832</h5>
                                    <p class="me-2">Cost</p>
                ...
                <div class="col-4 col-lg-4 col-xl-4 bg-white radius-10 m-3" style="width:31%">
                    <h4 class="m-3">Inventory Summary</h4>
                    <div class="d-flex ">
                        <div class="w-50">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Quantity.png') }}">
                                </div>
                                <div class="mt-5 mb-0">
                                    <h5 class="text-center">868</h5>
                                    <p class="text-center">Quantity in Hand</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-50">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/On the way.png') }}">
                                </div>
                                <div class="mt-5 mb-0">
                                    <h5 class="text-center">200</h5>
                                    <p class="text-center">To be received</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-8 col-xl-8 bg-white radius-10 m-3" style="width:63%">
                    <h4 class="m-3">Purchase Overview</h4>
                    <div class="d-flex">
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Purchase_Overview/Purchase.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-3">₹ 820</h5>
                                    <p class="me-2">Purchase</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    {{-- <i class='bx bx-cart fs-3 text-black'></i> --}}
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Purchase_Overview/Cost.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-4">₹ 13,573</h5>
                                    <p class="me-2">Cost</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25 border-end">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Purchase_Overview/Cancel.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-5">₹ 5</h5>
                                    <p class="me-2">Cancel</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-25">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Purchase_Overview/Profit.png') }}">
                                </div>
                                <div class="d-flex mt-5 mb-0">
                                    <h5 class="me-4">₹17,432</h5>
                                    <p class="me-2">Return</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-4 col-lg-4 col-xl-4 bg-white radius-10 m-3" style="width:31%">
                    <h4 class="m-3">Product Summary</h4>
                    <div class="d-flex ">
                        <div class="w-50">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Suppliers.png') }}">
                                </div>
                                <div class="mt-5 mb-0">
                                    <h5 class="text-center">31</h5>
                                    <p class="text-center">Number of Suppliers</p>
                                </div>
                            </div>
                        </div>
                        <div class="">
                            <div class="p-2 position-relative">
                                <div class="me-auto position-absolute start-50 translate-middle-x">
                                    <img src="{{ asset('assets/images/figma-icon/dashboard/Categories.png') }}">
                                </div>
                                <div class="mt-5 mb-0">
                                    <h5 class="text-center">21</h5>
                                    <p class="text-center">Number of Categories</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card radius-10 overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <h6 class="mb-0">Sales & Purchase</h6>
                                </div>
